%PrzykÄ¹â€šadowy plik uÄ¹â€šatwiajÃ„â€¦cy zÄ¹â€šoÄ¹Ä½enie projektu dyplomowego inÄ¹Ä½ynierskiego.
%UWAGA: Generowany napis na stronie tytuÄ¹â€šowej o treÄ¹â€ºci PROJEKT DYPLOMOWY INÄ¹Â»YNIERSKI zostaÄ¹â€š zaproponowany przeze mnie i nie jest, pÄ‚Å‚ki co, potwierdzony przez wÄ¹â€šadze wydziaÄ¹â€šu. Przed ostatecznym oddaniem tak zÄ¹â€šoÄ¹Ä½onej pracy naleÄ¹Ä½y upewniÃ„â€¡ siÃ„â„¢ jaka powinna byÃ„â€¡ treÄ¹â€ºÃ„â€¡ tego napisu. W momencie gdy uzyskam informacjÃ„â„¢ na temat treÄ¹â€ºci tego napisu, dokonam niezbÃ„â„¢dnych zmian w Ä¹ÅŸrÄ‚Å‚dÄ¹â€šach.

\documentclass[eng,printmode]{mgr}
%opcje klasy dokumentu mgr.cls zostaÄ¹â€šy opisane w doÄ¹â€šÃ„â€¦czonej instrukcji

%poniÄ¹Ä½ej deklaracje uÄ¹Ä½ycia pakietÄ‚Å‚w, usunÃ„â€¦Ã„â€¡ to co jest niepotrzebne
\usepackage{polski} %przydatne podczas skÄ¹â€šadania dokumentÄ‚Å‚w w j. polskim
%\usepackage[polish]{babel}%alternatywnie do pakietu polski, wybraÃ„â€¡ jeden z nich
\usepackage[utf8]{inputenc} %kodowanie znakÄ‚Å‚w, zaleÄ¹Ä½ne od systemu
\usepackage[T1]{fontenc} %poprawne skÄ¹â€šadanie polskich czcionek
...
%pakiety dodajÃ„â€¦ce duÄ¹Ä½o dodatkowych poleceÄ¹â€ž matematycznych
\usepackage{amsmath}
\usepackage{amsfonts}

%pakiety wspomagajÃ„â€¦ce i poprawiajÃ„â€¦ce skÄ¹â€šadanie tabel
\usepackage{supertabular}
\usepackage{array}
\usepackage{tabularx}
\usepackage{hhline}

%pakiet wypisujÃ„â€¦cy na marginesie etykiety rÄ‚Å‚wnaÄ¹â€ž i rysunkÄ‚Å‚w zdefiniowanych przez \label{}, chcÃ„â€¦c wygenerowaÃ„â€¡ finalnÃ„â€¦ wersjÃ„â„¢ dokumentu wystarczy usunÃ„â€¦Ã„â€¡ poniÄ¹Ä½szÃ„â€¦ liniÃ„â„¢
\usepackage{showlabels}

%definicje wÄ¹â€šasnych poleceÄ¹â€ž
\newcommand{\R}{I\!\!R} %symbol liczb rzeczywistych, dziaÄ¹â€ša tylko w trybie matematycznym
\newtheorem{theorem}{Twierdzenie}[section] %nowe otoczenie do skÄ¹â€šadania twierdzeÄ¹â€ž

%dane do zÄ¹â€šoÄ¹Ä½enia strony tytuÄ¹â€šowej
\title{TytuÄ¹â€š pracy inÄ¹Ä½ynierskiej}
\engtitle{English title}
\author{Jan Nowak}
\supervisor{dr hab. inÄ¹Ä½. ImiÃ„â„¢ Nazwisko Prof. PWr, I-6}
%\guardian{dr hab. inÄ¹Ä½. ImiÃ„â„¢ Nazwisko Prof. PWr, I-6} %nie uÄ¹Ä½ywaÃ„â€¡ jeÄ¹â€ºli opiekun jest tÃ„â€¦ samÃ„â€¦ osobÃ„â€¦ co prowadzÃ„â€¦cy pracÃ„â„¢

%\date{2008} %standardowo u doÄ¹â€šu strony tytuÄ¹â€šowej umieszczany jest bieÄ¹Ä½Ã„â€¦cy rok, to polecenie pozwala wstawiÃ„â€¡ dowolny rok

%poniÄ¹Ä½ej jest lista kierunkÄ‚Å‚w i specjalnoÄ¹â€ºci na wydziale elektroniki, naleÄ¹Ä½y wybraÃ„â€¡ wÄ¹â€šaÄ¹â€ºciwe lub dopisaÃ„â€¡ jeÄ¹â€ºli nie ma odpowiednich
\field{Automatyka i Robotyka (AIR)}
\specialisation{Robotyka (ARR)}
%\specialisation{Komputerowe sieci sterowania (ARK)}
%\specialisation{Systemy informatyczne w automatyce (ASI)}
%\specialisation{Komputerowe systemy zarzÃ„â€¦dzania \\procesami produkcyjnymi (ARS)}
...
%\specialisation{Zastosowania inÄ¹Ä½ynierii komputerowej \\w technice (EZI)}
%\specialisation{InÄ¹Ä½ynieria dÄ¹ÅŸwiÃ„â„¢ku (EID)}
...
%\specialisation{SygnaÄ¹â€šy w telekomunikacji cyfrowej (TSC)}
%\specialisation{Teleinformatyczne systemy rozsiewcze (TSR)}
%\field{Informatyka (INF)}
%\specialisation{Systemy informatyki w medycynie \\i technice (IMT)}
%\specialisation{InÄ¹Ä½ynieria systemÄ‚Å‚w informatycznych (INS)}
%\specialisation{InÄ¹Ä½ynieria internetowa (INT)}
%\specialisation{Systemy i sieci komputerowe (ISK)}
%\field{Teleinformatyka (TIN)}
%\specialisation{Teleinformatyka (TIN)}

%tutaj zaczyna siÃ„â„¢ wÄ¹â€šaÄ¹â€ºciwa treÄ¹â€ºÃ„â€¡ dokumentu
\begin{document}
\bibliographystyle{plabbrv} %tylko gdy uÄ¹Ä½ywamy BibTeXa, ustawia polski styl bibliografii

\maketitle %polecenie generujÃ„â€¦ce stronÃ„â„¢ tytuÄ¹â€šowÃ„â€¦
...
\tableofcontents %spis treÄ¹â€ºci

%poniÄ¹Ä½ej znajduje siÃ„â„¢ przykÄ¹â€šadowa treÄ¹â€ºÃ„â€¡ dalszej czÃ„â„¢Ä¹â€ºci dokumentu, zainteresowanych zachÃ„â„¢cam do rozszyfrowania frazy "Lorem ipsum" :)
\chapter{Lorem ipsum}
...
\addcontentsline{toc}{chapter}{Bibliografia} %utworzenie w spisie treÄ¹â€ºci pozycji Bibliografia
\bibliography{bibliografia} % wstawia bibliografiÃ„â„¢ korzystajÃ„â€¦c z pliku bibliografia.bib - dotyczy BibTeXa, jeÄ¹Ä½eli nie korzystamy z BibTeXa naleÄ¹Ä½y uÄ¹Ä½yÃ„â€¡ otoczenia thebibliography

%opcjonalnie moÄ¹Ä½e siÃ„â„¢ tu pojawiÃ„â€¡ spis rysunkÄ‚Å‚w i tabel
% \listoffigures
% \listoftables
\end{document}
