...
%opcje klasy dokumentu mgr.cls zosta³y opisane w do³šczonej instrukcji

%poni¿ej deklaracje u¿ycia pakietów, usunšæ to co jest niepotrzebne
...
%pakiety dodajšce du¿o dodatkowych poleceñ matematycznych
\usepackage{amsmath}
\usepackage{amsfonts}

%pakiety wspomagajšce i poprawiajšce sk³adanie tabel
\usepackage{supertabular}
\usepackage{array}
\usepackage{tabularx}
\usepackage{hhline}

%pakiet wypisujšcy na marginesie etykiety równañ i rysunków
%zdefiniowanych przez \label{}, chcšc wygenerowaæ finalnš wersjê
%dokumentu wystarczy usunšæ poni¿szš liniê
...
\author{Jan Nowak}
\supervisor{dr hab. in¿. Imiê Nazwisko Prof. PWr, I-6}
%\guardian{dr hab. in¿. Imiê Nazwisko Prof. PWr, I-6} %nie u¿ywaæ
%jeœli opiekun jest tš samš osobš co prowadzšcy pracê

%\date{2008} %standardowo u do³u strony tytu³owej umieszczany jest
%bie¿šcy rok, to polecenie pozwala wstawiæ dowolny rok

%poni¿ej jest lista kierunków i specjalnoœci na wydziale elektroniki,
%nale¿y wybraæ w³aœciwe lub dopisaæ jeœli nie ma odpowiednich
\field{Automatyka i Robotyka (AIR)}
\specialisation{Robotyka (ARR)}
%\specialisation{Komputerowe sieci sterowania (ARK)}
%\specialisation{Systemy informatyczne w automatyce (ASI)}
%\specialisation{Komputerowe systemy zarzšdzania \\procesami
...
%komputerowej \\w technice (EZI)} \specialisation{In¿ynieria dŸwiêku
...
\maketitle %polecenie generujšce stronê tytu³owš 

\dedication{6cm}{To jest przyk³adowa treœæ opcjonalnej dedykacji,
  nale¿y jš zmieniæ lub usunšæ w ca³oœci polecenie
  \texttt{$\backslash$dedication}}

\tableofcontents %spis treœci

%poni¿ej znajduje siê przyk³adowa treœæ dalszej czêœci dokumentu,
%zainteresowanych zachêcam do rozszyfrowania frazy "Lorem ipsum" :)
\chapter{Lorem ipsum}
...
\addcontentsline{toc}{chapter}{Bibliografia} %utworzenie w
                                             %spisietreœci pozycji
                                             %Bibliografia

\bibliography{bibliografia} % wstawia bibliografiê korzystajšc z pliku
