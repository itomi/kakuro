...
%pakiety dodajĂÂce duÄšĹşo dodatkowych poleceÄšÂ matematycznych
\usepackage{amsmath}
\usepackage{amsfonts}
...
\newtheorem{theorem}{Twierdzenie}[section] %nowe otoczenie do
                                           %skÄšÂadania twierdzeÄšÂ

%dane do zÄšÂoÄšĹşenia strony tytuÄšÂowej
\title{TytuÄšÂ pracy magisterskiej}
\engtitle{Master thesis title}
\author{Jan Nowak}
\supervisor{dr hab. inÄšĹş. ImiĂÂ Nazwisko Prof. PWr, I-6}
%\guardian{dr hab. inÄšĹş. ImiĂÂ Nazwisko Prof. PWr, I-6} %nie uÄšĹşywaĂÂ
%jeÄšÂli opiekun jest tĂÂ samĂÂ osobĂÂ co prowadzĂÂcy pracĂÂ

%\date{2008} %standardowo u doÄšÂu strony tytuÄšÂowej umieszczany jest
...
%naleÄšĹşy wybraĂÂ wÄšÂaÄšÂciwe lub dopisaĂÂ jeÄšÂli nie ma odpowiednich
\field{Automatyka i Robotyka (AIR)}
\specialisation{Robotyka (ARR)}
%\specialisation{Komputerowe sieci sterowania (ARK)}
%\specialisation{Systemy informatyczne w automatyce (ASI)}
%\specialisation{Komputerowe systemy zarzĂÂdzania \\procesami
...
%\\systemy automatyki (ESA)} \specialisation{Zastosowania inÄšĹşynierii
%komputerowej \\w technice (EZI)} \specialisation{InÄšĹşynieria dÄšĹwiĂÂku
...
%\specialisation{SygnaÄšÂy w telekomunikacji cyfrowej (TSC)}
%\specialisation{Teleinformatyczne systemy rozsiewcze (TSR)}
%\field{Informatyka (INF)} \specialisation{Systemy informatyki w
%medycynie \\i technice (IMT)} \specialisation{InÄšĹşynieria systemÄĹw
%informatycznych (INS)} \specialisation{InÄšĹşynieria internetowa (INT)}
%\specialisation{Systemy i sieci komputerowe (ISK)}
%\field{Teleinformatyka (TIN)} \specialisation{Teleinformatyka (TIN)}

%tutaj zaczyna siĂÂ wÄšÂaÄšÂciwa treÄšÂĂÂ dokumentu
\begin{document}
\bibliographystyle{plabbrv} %tylko gdy uÄšĹşywamy BibTeXa, ustawia polski
                            %styl bibliografii

\maketitle %polecenie generujĂÂce stronĂÂ tytuÄšÂowĂÂ 
...
\tableofcontents %spis treÄšÂci

%poniÄšĹşej znajduje siĂÂ przykÄšÂadowa treÄšÂĂÂ dalszej czĂÂÄšÂci dokumentu,
%zainteresowanych zachĂÂcam do rozszyfrowania frazy "Lorem ipsum" :)
\chapter{Lorem ipsum}
